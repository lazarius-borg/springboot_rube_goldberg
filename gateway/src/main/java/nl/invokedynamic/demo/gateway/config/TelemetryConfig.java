...
import nl.invokedynamic.demo.gateway.telemetry.OpenTelemetryLogbackAppender;
...
/**
 * Active OpenTelemetry logging and distributed tracing configuration for the API Gateway.
 */
@Configuration
public class TelemetryConfig implements org.springframework.beans.factory.SmartInitializingSingleton {
    ...
    public void afterSingletonsInstantiated() {
        if (sdkLoggerProvider != null) {
            ...
            // Ensure root logger captures DEBUG so OTLP export includes all levels
