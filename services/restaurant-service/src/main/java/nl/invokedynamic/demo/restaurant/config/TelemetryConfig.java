...
/**
 * Active OpenTelemetry logging and distributed tracing configuration for restaurant-service.
 */
@Configuration
public class TelemetryConfig implements SmartInitializingSingleton {
    ...
    public TelemetryConfig(
            @Value("${spring.application.name:restaurant-service}") String serviceName,
