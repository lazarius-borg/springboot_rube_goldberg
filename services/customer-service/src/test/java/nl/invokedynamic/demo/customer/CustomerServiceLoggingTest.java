...
class CustomerServiceLoggingTest {
    ...
    private static final Logger log = LoggerFactory.getLogger(CustomerServiceLoggingTest.class);
    ...
    void testOtlpLoggingAndTracingPropertiesConfigured() {
        contextRunner.run(context -> {
            ...
            log.info("Customer service structured logging verification event emitted successfully");
        });
    }
}
