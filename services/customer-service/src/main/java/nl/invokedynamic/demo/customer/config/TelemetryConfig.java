...
/**
 * Active OpenTelemetry logging and distributed tracing configuration for customer-service.
 */
@Configuration
public class TelemetryConfig implements SmartInitializingSingleton {
    ...
    public TelemetryConfig(
            @Value("${spring.application.name:customer-service}") String serviceName,
