package nl.invokedynamic.demo.reservation.config;
...
/**
 * Active OpenTelemetry logging and distributed tracing configuration for reservation-service.
 */
@Configuration
public class TelemetryConfig implements SmartInitializingSingleton {
    ...
    public TelemetryConfig(
            @Value("${spring.application.name:reservation-service}") String serviceName,
