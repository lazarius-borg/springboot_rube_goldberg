...
/**
 * Active OpenTelemetry logging and distributed tracing configuration for availability-service.
 */
@Configuration
public class TelemetryConfig implements SmartInitializingSingleton {
    ...
    public TelemetryConfig(
            @Value("${spring.application.name:availability-service}") String serviceName,
